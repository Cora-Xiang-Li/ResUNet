...
class UNet(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, bn_training=True, dropout_training=True, layers=4, features_root=32,
        ...
        # Locality Sensitive Block
        self.locality_sensitive_block = nn.Sequential(
    ...
    def forward(self, x):
        ...
        # Attention mechanism
        # loc_out = self.locality_sensitive_block(output)
        # attn_map = self.attention(loc_out)
