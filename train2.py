'''
    This is the very plain training process
'''
import datetime
import os
import time
...
from utils import AverageMeter, Model_Logger, layer_maker
...
def train(args):
    ...
    # model = UNet(momentum=args.BN_momentum, dropout=args.dropout)
    model = ResUNet()
